<?php
  ...
  if ($action=='create') wiki_content_create_received ();
  if ($action=='setparent') wiki_content_set_parent ($id, $pid);
  ...
  if ($action=='editroot') include 'editroot.php';else
    {
      if ($action=='save') {
        if ($id<>1) {
      ...
      if ($action=='delete') wiki_content_delete ($id); else
      if ($action=='up') wiki_content_up ($id);
      if ($action=='down') wiki_content_down ($id);
