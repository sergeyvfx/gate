...
<? } ?>
  function check (frm) {
    ...
    if (qtrim (login).length><?=$max_login_len;?>) {alert ('Логин создаваемого пользователя может содержать не более <?=$max_login_len;?> символов.'); return false;}
    if (qtrim (name)=='') { alert ('Имя создаваемого пользователя не может быть пустым.'); return false; }
    if (qtrim (name).length><?=$max_name_len;?>) {alert ('Имя создаваемого пользователя может содержать не более <?=$max_name_len;?> символов.'); return false;}
    ...
    if (passwd.length><?=$max_passwd_len;?>) {alert ('Пароль создаваемого пользователя может содержать не более <?=$max_passwd_len;?> символов.'); return false;}
  ...
  function check_login () {
    ...
    if (qtrim (login).length><?=$max_login_len;?>) {show_msg ('login_check_res', 'err', 'Логин пользователя может содержать не более <?=$max_login_len;?> символов.'); return false;}
