...
<script language="JavaScript" type="text/javascript">
  function check (frm) {
    ...
    if (qtrim (name)=='') {alert ('Название создаваемого хранилища данных не может быть пустым.'); return false;}
    if (!checkDir ('/'+path)) {alert ('Указан некорректный путь. В названиях каталогов могут быть лишь буквы латинского алфавита и цифры.'); return false;}
    frm.submit ();
  }
  ...
  function check_path () {
    var path=getElementById ('path').value;
    if (!checkDir ('/'+path)) { show_msg ('path_check_res', 'err', 'Указан некорректный путь. В названиях каталогов могут быть лишь буквы латинского алфавита и цифры.'); return false; }
