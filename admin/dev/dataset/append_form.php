...
<script language="JavaScript" type="text/javascript">
  function appcheck (frm) {
    ...
    if (qtrim (ftitle)=='') { alert ('Имя создаваемого поля не может быть пустым.'); return false; }
    if (!isalphanum (field)) { alert ('Название поля может содержать лишь символы латинского алфавита и цифры.'); return false; }
    if (datatype=='') { alert ('Не указан тип данных для использования.'); return false; }
    frm.submit ();
  }
