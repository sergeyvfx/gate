...
<form action=".?action=save&id=<?= $id; ?>&<?= (($page != '') ? ('&page=' . $page) : ('')); ?>" method="POST" onsubmit="check (this); return false;">
        ...
        <tr><td width="30%" style="padding: 0 2px;">
            ...
            <td style="padding: 0 2px;">
                <select id="paymentOption" name="paymentOption">
                    <option value="1" <?= $payment['payment_option']=="1" ? 'selected="selected"' : '' ?>>Учебный центр "Информатика" (банковский перевод)</option>
                    <option value="2" <?= $payment['payment_option']=="2" ? 'selected="selected"' : '' ?>>Учебный центр "Информатика" (безналичный расчет)</option>
                    <option value="3" <?= $payment['payment_option']=="3" ? 'selected="selected"' : '' ?>>Учебный центр "Информатика" (в кассе)</option>
                    <option value="4" <?= $payment['payment_option']=="4" ? 'selected="selected"' : '' ?>>Яндекс.Деньги</option>
                    <option value="5" <?= $payment['payment_option']=="5" ? 'selected="selected"' : '' ?>>Перевод на карту Сбербанка (по номеру карты)</option>
                    <option value="6" <?= $payment['payment_option']=="6" ? 'selected="selected"' : '' ?>>Перевод на карту Сбербанка (по реквизитам)</option>
                    <option value="-1" <?= ($payment['payment_option']=="-1" || $payment['payment_option']=="") ? 'selected="selected"' : '' ?>>Другое (указать в примечании)</option>
                </select>
            </td>
        </tr>
    </table>
    ...
    <table class="clear" width="100%">
        <tr><td width="30%" style="padding: 0 2px;">
            ...
            <td style="padding: 0 2px;">
                <input type="text" id="amount" name="amount" value="<?= htmlspecialchars(stripslashes($payment['amount'])); ?>" class="txt block">
            </td>
        </tr>
    </table>
    ...
    <table class="clear" width="100%">
        <tr><td width="30%" style="padding: 0 2px;">
            ...
            <td style="padding: 0 2px;">
                <input type="text" id="teamNumbers" name="teamNumbers" value="<?= htmlspecialchars(stripslashes($payment['team_numbers'])); ?>" class="txt block">
            </td>
        </tr>
    </table>
    ...
    <table class="clear" width="100%">
        <tr><td width="30%" style="padding: 0 2px;">
            ...
            <td style="padding: 0 2px;">
                <input type="text" id="payer_full_name" name="payer_full_name" value="<?= htmlspecialchars(stripslashes($payment['payer_full_name'])); ?>" class="txt block">
            </td>
        </tr>
    </table>
    ...
    <table class="clear" width="100%">
        <tr><td width="30%" style="padding: 0 2px;">
            ...
            <td style="padding: 0 2px;">
                <input type="text" id="cheque_number" name="cheque_number" value="<?= htmlspecialchars(stripslashes($payment['cheque_number'])); ?>" class="txt block">
            </td>
        </tr>
    </table>
    ...
    <table class="clear" width="100%">
        <tr><td width="30%" style="padding: 0 2px;">
            ...
            <td style="padding: 0 2px;">
                <input type="text" id="comment" name="comment" value="<?= htmlspecialchars(stripslashes($payment['comment'])); ?>" class="txt block">
            </td>
        </tr>
    </table>
