  ...
  if ($_manage_dev_included_ != '#manage_dev_Included#') {
    ...
    function manage_check_tables () {
        ...
        if (!db_table_exists ('settings')) {
          ...
          db_insert ('settings', array ('section'=>'"Системные"', 'name'=>'"Максимальная длина фамилии пользователя"', 'ident'=>'"max_user_surname_len"', 'class'=>'"CSCNumber"', 'settings'=>'"'.addslashes ('a:1:{s:5:"value";s:2:"32";}').'"', 'used'=>'1'));
          ...
          db_insert ('settings', array ('section'=>'"Системные"', 'name'=>'"Максимальная длина отчества пользователя"',  'ident'=>'"max_user_patronymic_len"', 'class'=>'"CSCNumber"', 'settings'=>'"'.addslashes ('a:1:{s:5:"value";s:2:"32";}').'"', 'used'=>'1'));
          db_insert ('settings', array ('section'=>'"Системные"', 'name'=>'"Максимальная длина телефона пользователя"',  'ident'=>'"max_user_phone_len"', 'class'=>'"CSCNumber"', 'settings'=>'"'.addslashes ('a:1:{s:5:"value";s:2:"12";}').'"', 'used'=>'1'));
