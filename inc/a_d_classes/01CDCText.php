<?php if ($_CDCText_!='#CDCText_included#') {$_CDCText_='#CDCText_included#';
...
<?php
    ...
    function ReceiveSettings () { global $_POST; $this->SetSetting ('nlines', $_POST['CDCText_nLines']); return true; }
    ...
    function BuildCheckImportancy ($var, $formname='') { $dummy=$formname.'_'.$var; return "(qtrim (getElementById ('$dummy').value)!='')"; }
