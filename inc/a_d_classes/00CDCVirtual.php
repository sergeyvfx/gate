<?php if ($_CDCVirtual_!='#CDCVirtual_included#') {$_CDCVirtual_='#CDCVirtual_included#';
  class CDCVirtual extends CVirtual {
    var $val;
    function FromTemplate       ($tpl,$args=array ()) {return tpl ('back/dclasses/'.$this->GetClassName ().'/'.$tpl,$args);}
    ...
    function ReceiveValue       ($field, $formname='') { $this->val=stripslashes ($_POST[$formname.'_'.$field]); }
