<?php if ($_WT_included_!='###WT_Inclided###') { $_WT_util_included_='###WT_Inclided###';
  ...
  class WebTester {
    ...
    function AuthRoot () {
      return $this->Auth ($this->OptGet ('WT_server_login', 'WT-login'), $this->OptGet ('WT_server_pass', 'WT-pass'));
    }
