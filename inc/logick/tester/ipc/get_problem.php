<?php if ($_WT_ipc_get_problem_included_!='###WT_IPC_GetProblem_Inclided###') { $_WT_ipc_get_problem_included_='###WT_IPC_GetProblem_Inclided###';
  ...
  function WT_GetProblem () {
    ...
    if (preg_match ('/[0-9]+/', ($s['checker']))) $arr['CHECKER']=$s['checker'];
