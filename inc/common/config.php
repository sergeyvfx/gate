<?php if ($_configSet_included_!='#configSet_Included#') {$_configSet_included_='#configSet_Included#'; 

  config_set ('proto', (($_SERVER['HTTPS']!='')?('https'):('http')));

  config_set ('php-version', preg_replace ('/^([0-9]).*/', '\1', phpversion ())); // Major version of php
