function CONTENT_SetOpening (wnd) {
  ...
  if (wnd!=null)
    var document=wnd.document; else
    wnd=window;
  ...
  if (!wnd.CONTENT_wait_widget) {
    ...
    wnd.CONTENT_wait_widget.innerHTML='<table class="clear" style="margin: 0 4px; height: 26px; width: 100%;"><tr><td style="padding-right: 8px;"><img src="'+document_root+'/pics/wait.gif"></td><td>Загрузка...</td></tr></table>';
  }
